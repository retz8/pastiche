...
FormControl:
  ...
  className?: string
  style?: "React.CSSProperties"
FormControlLabel: { pkg: "@primer/react" }
...
Heading:
  pkg: "@primer/react"
  spreads: ["ComponentProps<typeof Heading>"]
Label:
  pkg: "@primer/react"
...
Link:
  pkg: "@primer/react"
  spreads: ["ComponentProps<typeof Link>"]
NavList:
  pkg: "@primer/react"
...
Overlay:
  pkg: "@primer/react"
  spreads: ["ComponentPropsWithRef<typeof Overlay>"]
Pagination:
  pkg: "@primer/react"
  className?: string
  pageCount: number
...
Timeline:
  pkg: "@primer/react"
  spreads: ["React.ComponentPropsWithoutRef<'div'>"]
  clipSidebar?: "bool | 'start' | 'end' | 'both'"
  className?: string
TimelineBadge:
  pkg: "@primer/react"
  spreads: ["React.ComponentPropsWithoutRef<'div'>"]
...
Tooltip:
  pkg: "@primer/react"
  spreads: ["React.PropsWithChildren<{ direction?: TooltipDirection; text: string; type?: 'label' | 'description'; keybindingHint?: KeybindingHintProps['keys'] | Array<KeybindingHintProps['keys']>; delay?: 'short' | 'medium' | 'long'; _privateDisableTooltip?: bool; }>", React.HTMLAttributes<HTMLElement>]
Truncate:
  pkg: "@primer/react"
  spreads: [React.HTMLAttributes<HTMLElement>]
  title: string
...
UnderlineNavItem: { pkg: "@primer/react" }
ActionBar:
  pkg: "@primer/react"
  variants:
    - size?: [small, medium, large]
...
PageHeaderTitle: { pkg: "@primer/react" }
PageHeaderActions: { pkg: "@primer/react" }
PageHeaderTitleArea: { pkg: "@primer/react" }
Button:
  pkg: "@primer/react"
...
Autocomplete.Menu: { pkg: "@primer/react" }
Autocomplete.Overlay: { pkg: "@primer/react" }
Banner.Title: { pkg: "@primer/react" }
Banner.Description: { pkg: "@primer/react" }
Details.Summary: { pkg: "@primer/react" }
FormControl.Caption: { pkg: "@primer/react" }
PageLayoutPaneBase:
  pkg: "@primer/react"
...
BannerPrimaryAction: { pkg: "@primer/react" }
BannerSecondaryAction: { pkg: "@primer/react" }
...
GroupHeadingTrailingAction: { pkg: "@primer/react" }
...
FilteredActionList:
  pkg: "@primer/react"
  spreads: ["Partial<Omit<GroupedListProps, keyof ListPropsBase>>", ListPropsBase]
  loading?: bool
  loadingType?: FilteredActionListLoadingType
  placeholderText?: string
  filterValue?: string
...
FilteredActionList.Input: { pkg: "@primer/react" }
...
ActionBarIconButton:
  ...
  spreads: [IconButtonProps]
  disabled?: bool
ActionBarGroup: { pkg: "@primer/react" }
...
FilteredActionListInput:
  ...
  loading: bool
  fullScreenOnNarrow?: bool
FilteredActionListBodyLoader: { pkg: "@primer/react" }
```
