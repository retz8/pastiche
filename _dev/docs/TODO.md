...
- [x] **8.3** `LICENSE` — MIT (§14.5). *Independent; details defer to task spec.*
- [x] **8.4** `README.md`: positioning, quickstart (real `/plugin marketplace add` flow). *Details defer to task spec.* (First-pass draft; revisit before release.)
